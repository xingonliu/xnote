...
笔记的段落样式、行内样式、清单、对齐、表格和折叠命令统一通过 `XNoteRichTextToolbar` 发出。格式工具栏贴在键盘上方或页面底部，必须保留底部 Progressive blur。“添加图片”统一放在编辑页右上角“更多”下拉菜单中，打开相机/相册来源选择；页面底部不再保留独立添加图片按钮，工具栏占位为 64 dp。
